...
class Devmenu extends Base
{
    ...
    private function saveData($parame)
    {
        ...
        $saveData['icon2']          = isset($parame['icon2']) ? $parame['icon2'] : '';
        $saveData['describe']       = isset($parame['describe']) ? $parame['describe'] : '';
        ...
        if ($id > 0 && $saveData['pid'] == $id) return ['Code' => '203', 'Msg'=>lang('notice_owner_children')];
